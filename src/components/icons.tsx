...
const ICONS = {
  ...
  eyeOff: () => (
    <>
      <path d="M10.6 5.1A10.9 10.9 0 0 1 12 5c6.5 0 10 7 10 7a17.6 17.6 0 0 1-2.6 3.6" />
  ...
  cycle: () => (
    <>
      <path d="M20.5 12a8.5 8.5 0 0 1-14.3 6.2L3.5 15.8" />
      <path d="M3.5 12a8.5 8.5 0 0 1 14.3-6.2l2.7 2.4" />
      <path d="M20.5 4.5V8.2h-3.7" />
      <path d="M3.5 19.5v-3.7h3.7" />
    </>
  ),
  trend: () => (
    <>
